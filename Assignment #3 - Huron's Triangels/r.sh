...
gcc  -m64 -Wall -no-pie -o triangle.o -std=c++20 -c triangle.cpp

echo "Link the object modules to create an executable file"
g++  -m64 -no-pie -o compute.out manager.o isfloat.o istriangle.o huron.o triangle.o -std=c++20 -Wall -z noexecstack -lm

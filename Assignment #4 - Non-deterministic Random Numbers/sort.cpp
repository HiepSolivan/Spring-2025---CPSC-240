...
//
//===== Begin code area ===================================================================================================================================================
extern "C" void sort (double array [], long size);

void sort (double array [], long size) {
  double temp = 0.0;
  for (int inner_index = 0; inner_index < size; ++inner_index)
  {
    for (int outer_index = 0; outer_index < size - inner_index - 1; ++outer_index)
    {
      if (array[outer_index] > array[outer_index + 1])
      {
        temp = array[outer_index];
        array[outer_index] = array[outer_index + 1];
        array[outer_index + 1] = temp;
      }
    }
  }
}

...
nasm -f elf64 -gdwarf -l faraday.lis -o faraday.o faraday.asm

echo "Assemble the source file edison.asm"
nasm -f elf64 -gdwarf -l edison.lis -o edison.o edison.asm

echo "Assemble the source file syscall_fgets.asm"
nasm -f elf64 -gdwarf -l syscall_fgets.lis -o syscall_fgets.o syscall_fgets.asm

echo "Assemble the source file syscall_strlen.asm"
nasm -f elf64 -gdwarf -l syscall_strlen.lis -o syscall_strlen.o syscall_strlen.asm
...
nasm -f elf64 -gdwarf -l atof.lis -o atof.o atof.asm

echo "Assemble the source file tesla.asm"
nasm -f elf64 -gdwarf -l tesla.lis -o tesla.o tesla.asm

echo "Assemble the source file ftoa.asm"
nasm -f elf64 -gdwarf -l ftoa.lis -o ftoa.o ftoa.asm

echo "Link the object modules to create an executable file"
ld -g -o electricity.out faraday.o edison.o syscall_fgets.o syscall_strlen.o input_array.o isfloat.o atof.o tesla.o ftoa.o

echo "Debug the program in GDB"
